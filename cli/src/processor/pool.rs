...
use open_clockwork_network_program::state::{Config, Pool, Registry, PoolSettings};
...
pub fn update(client: &Client, id: u64, size: usize) -> Result<(), CliError> {
    ...
    let ix = Instruction {
        ...
        accounts: open_clockwork_network_program::accounts::PoolUpdate {
        ...
        data: open_clockwork_network_program::instruction::PoolUpdate { settings }.data(),
    };
